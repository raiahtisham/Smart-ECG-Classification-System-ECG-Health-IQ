...
const NavigationBar = ({ email }) => {
  ...
  const { theme, toggleTheme, isDarkMode } = useTheme(); // this will now work reactively
  ...
  return (
    <View style={styles.navbar}>
      ...
      <TouchableOpacity onPress={toggleTheme} style={styles.iconContainer}>
        <Icon
          name={isDarkMode ? "sun" : "moon"} //  uses correct isDarkMode flag
          size={26}
      ...
      <TouchableOpacity
        onPress={() => navigation.navigate("SettingsScreen", { email })}
        style={[
          styles.iconContainer,
          isActive("Settings") && styles.activeIcon,
        ]}
      >
